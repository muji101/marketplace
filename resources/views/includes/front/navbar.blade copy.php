    ...
    <div class="sticky top-0 z-10 bg-white mx-auto px-16 my-4  shadow-md">
                            ...
                            <div class="col-span-2 p-2 h-full overflow-auto">
                                {{-- <ul  id="tabs1"> --}}
                                    ...
                                    @foreach ($categoryall as $item)
                                        {{-- <li><a href="#{{ $id++ }}" class="p-2 hover:bg-gray-100 text-sm rounded block">{{ $item->name }}</a></li> --}}
                                        <li><a href="{{ route('home', $item->id) }}" class="p-2 hover:bg-gray-100 text-sm rounded block">{{ $item->name }}</a></li>
                                    @endforeach
                                {{-- </ul> --}}
                            </div>
                                ...
                                <div id="tab-contents1">
                                    <div  id="{{ $id++ }}" >
                                        <div class="p-4 flex space-x-2 items-center">
                                            ...
                                            <ul class="p-4">
                                                @foreach ($subcategoryall as $item)
                                                <li><a href="#" class="p-2 hover:bg-gray-100 text-sm rounded block">{{ $item->name }}</a></li>
                                                @endforeach
                                            </ul>
                                    </div>
                                </div>
        ...
        <div class="col-span-1 flex items-center border-l-2 space-x-2 pl-10">
            <div class="py-2">
                <a href="/login" class="border-2 border-blue-400 py-2 px-4 rounded-lg text-blue-400 font-bold">Masuk</a>
            </div>
            <div class="py-2">
                <a href="/register" class=" py-2 px-4 rounded-lg bg-blue-400 text-white font-bold ring-2 ring-blue-400">Daftar</a>
            </div>
        </div>
        @endguest
        ...
        <div class="col-span-1 flex items-center border-l-2">
            <div class="dropdown inline px-2 py-1 rounded text-gray-500 hover:text-gray-700 hover:bg-gray-200 cursor-pointer text-base tracking-wide">
                <div class="flex items-center space-x-2">
                    ...
                    <p class="text-gray-500 text-sm">{{ Str::limit(Auth::user()->store->name, 7) }}</p>
                </div>
                <div class="dropdown-menu absolute hidden w-96 text-gray-700  h-auto flex pt-4">
                    <div class="transform -translate-x-1/2 block w-full bg-white shadow p-4  rounded-md">
