    ...
    <div class="sticky top-0 z-10 bg-white mx-auto px-16 my-4  shadow-md">
        ...
        <div class="col-span-1 flex items-center border-l-2 space-x-2 pl-10">
            ...
            <div class="py-2">
                <a href="/register" class=" py-2 px-4 rounded-lg bg-red-400 text-white font-bold ring-2 ring-red-400">Daftar</a>
            </div>
        </div>
        @endguest
                        ...
                        <div class="py-2 space-y-1 text-center">
                            ...
                            <div class="text-center bg-red-400 rounded-md py-1">
                                ...
                                <form method="POST" action="{{ url('/logout') }}">
                                    @csrf
                                    <a class="text-white font-bold text-sm" href="{{ url('/logout') }}"
