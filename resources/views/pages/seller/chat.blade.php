            ...
            <div class="search-result">
                <div class="search-result__content">
                    ...
                    <div class="mb-5">
                        ...
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/profile-10.jpg">
                            </div>
                    ...
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/preview-3.jpg">
                        </div>
                    ...
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/preview-9.jpg">
                        </div>
                        <div class="ml-3">Oppo Find X2 Pro</div>
                        <div class="ml-auto w-48 truncate text-gray-600 text-xs text-right">Smartphone &amp; Tablet</div>
                    </a>
                    ...
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/preview-8.jpg">
                        </div>
        ...
        <div class="intro-x dropdown mr-auto sm:mr-6">
            ...
            <div class="notification-content pt-2 dropdown-menu">
                <div class="notification-content__box dropdown-menu__content box dark:bg-dark-6">
                    ...
                    <div class="cursor-pointer relative flex items-center mt-5">
                        <div class="w-12 h-12 flex-none image-fit mr-1">
                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/profile-14.jpg">
                            <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                        </div>
                        <div class="ml-2 overflow-hidden">
                            <div class="flex items-center">
                ...
                <div id="chats" class="tab-pane active" role="tabpanel" aria-labelledby="chats-tab">
                                ...
                                <div class="flex mt-5">
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/profile-6.jpg">
                                            <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                        </div>
                                    ...
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        ...
                                        <div class="text-xs text-gray-600 truncate text-center mt-2">Brad Pitt</div>
                                    </a>
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/profile-10.jpg">
                                    ...
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/profile-1.jpg">
                                            <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                        </div>
                                    ...
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/profile-13.jpg">
                                            <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                        </div>
                                    ...
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/profile-5.jpg">
                                            <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                        </div>
                    ...
                    <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
                        ...
                        <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                            ...
                            <div class="w-5 h-5 flex items-center justify-center absolute top-0 right-0 text-xs text-white rounded-full bg-theme-1 font-medium -mt-1 -mr-1">2</div>
                        </div>
                        <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="source/dist/images/profile-11.jpg">
