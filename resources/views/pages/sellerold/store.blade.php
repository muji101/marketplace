...
@include('includes.back.topbar')
    <div class="p-2 mt-2">
                ...
                <div class="col-span-1 border-2 rounded p-4">
                    <div class="grid grid-cols-2">
                        <div class="col-span-1">
                            ...
                            <div class="pt-4">
                                <a href="#" class="py-2 px-4 rounded bg-gray-300">Ubah</a>
                            </div>
                        </div>
                        <div class="col-span-1">
        ...
        <div class="text-right py-4">
            <a href="#" class="py-2 px-4 bg-gray-300 rounded font-bold  ">Simpan</a>
        </div>
    </div>
    ...
    <div class="p-2">
        ...
        <span>
            <a href="#" class="py-2 px-4 bg-gray-300 rounded border-2 border-gray-500">Buka Toko</a>
            <a href="#" class="py-2 px-4 bg-gray-300 rounded">Tutup Toko</a>
        </span>
    </div>
    <div class="p-2">
