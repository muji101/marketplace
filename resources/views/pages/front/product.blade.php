    ...
    <div class="grid grid-cols-4 gap-8 text-left">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="col-span-2">
                    <div class="pb-4 text-left">
                        <h1 class="font-bold">Kapas Filter Air Humidifier Diffuser Purifier Replacement Cotton Swab</h1>
        ...
        <div class="col-span-1">
            <div class="sticky top-32">
                ...
                <img src="https://images.tokopedia.net/img/jdvdtx/2021/9/27/9cd8da60-7353-4756-a187-d234a90e3fb3.jpg" alt="">
            </div>
        </div>
    </div>
