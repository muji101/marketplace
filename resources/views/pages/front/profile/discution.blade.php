...
<div class="mx-4 h-auto p-4 border-2 rounded-lg bg-blue-50">
    <div class="flex items-center space-x-2 pb-4">
        ...
        <div class="">
            <p class="text-gray-600 hover:text-blue-400">Handsfree Bluetooth I7S TWS Sport True Wireless Airpods I7S V5.0</p>
    ...
    <div class="grid grid-cols-12 pt-4">
        ...
        <div class="col-span-11">
            ...
            <div class="flex items-center space-x-2 border-l-4 pl-2 my-2">
                ...
                <div class="">
                    <p class="text-gray-600 hover:text-blue-400">T-Men Accessories<span class="px-2 py-1 bg-gray-50 text-blue-500 font-bold rounded text-xs">Penjual</span></p>
                    <p>3-4 jam</p>
                </div>
            </div>
            <div class="py-2">
