            ...
            <div class="grid grid-cols-4">
                    ...
                    <div class="text-left px-4">
                        ...
                        <div class="text-sm border-t-2 border-b-2 my-2 py-2">
                            <div class="space-x-1">
                                ...
                                <span>(Rumah)</span>
                                <span class="bg-green-100 text-green-600 text-xs py-1 px-2">Utama</span>
                            </div>
                            <p>6285747245474</p>
                        ...
                        <div class="flex justify-between items-center space-x-3 py-4 border-b-2">
                            ...
                            <div class="font-bold">
                                <h2>Pilih Durasi</h2>
                                <button class="bg-green-400 rounded-lg px-32 py-2 font-bold text-white">Pengiriman</button>
                            </div>
                        </div>
                ...
                <div class="col-span-1">
                    <div class="border-2 rounded-lg p-4 sticky top-32">
                        ...
                        <button  class="py-2 w-full bg-green-400 rounded-lg font-bold text-md text-white">Pilih Pembayaran</button>
                    </div>
                </div>
            </div>
        </div>
