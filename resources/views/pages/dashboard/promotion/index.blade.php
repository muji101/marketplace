...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href="{{ route('promotions.create') }}" class="btn btn-primary shadow-md mr-2">Add New Promotion</a>
        <div class="dropdown">
                    ...
                    <td class="w-40">
                        <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                                <img data-action="zoom" alt="photo" class="tooltip rounded-full" src="{{ asset('/storage/'.$promotion->photo) }}" title="Uploaded at {{ $promotion->created_at }}">
                            </div>
                        </div>
                    </td>
                    <td>
                        <a href="" class="font-medium whitespace-nowrap">{{ $promotion->name }}</a> 
                        <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">{{ $promotion->created_at }}</div>
                    </td>
                    <td class="text-center">{{ $promotion->category->name }}</td>
                    <td class="text-center">{{ $promotion->type }}</td>
                    {{-- <td class="w-40">
