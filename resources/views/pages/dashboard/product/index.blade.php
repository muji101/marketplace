            ...
            <tbody>
                ...
                <tr class="intro-x">
                    ...
                    <td>
                        ...
                        <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">{{ $product->subcategory->name }}</div>
                    </td>
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            <a class="flex items-center mr-3 text-theme-12" href="{{ route('products.show', $product->id) }}"> <i data-feather="eye" class="w-4 h-4 mr-1"></i> Show </a>
