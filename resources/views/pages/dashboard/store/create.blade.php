            ...
            <div class="intro-y box p-5">
                ...
                <div class="mt-3"> 
                    ...
                    <select data-placeholder="Select your favorite actors" class="tom-select w-full">
                        <option value="1" selected>Official Store</option>
                        <option value="2">Power Merchant Pro</option>
                        <option value="3">Power Merchant</option>
                    </select>
                </div>
                <div class="mt-3">
                    <label for="crud-form-1" class="form-label">Slogan</label>
                    <input id="crud-form-1" type="text" class="form-control w-full" placeholder="Input Slogan">
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3"> 
                    <label for="crud-form-2" class="form-label">Pemilik Toko</label>
                    <select data-placeholder="Select your favorite actors" class="tom-select w-full">
