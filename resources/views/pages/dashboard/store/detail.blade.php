        ...
        <div class="flex flex-col lg:flex-row border-b border-gray-200 dark:border-dark-5 pb-5 -mx-5">
            <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                    <img alt="photo" class="rounded-full" src="{{ asset('/storage/'.$stores->photo) }}">
                ...
                <div class="ml-5">
                    <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg">{{ $stores->name }}</div>
                    <div class="text-gray-600">
                        <i data-feather="map-pin" class="w-4 h-4 mr-2"></i> {{ $stores->address }}
                    </div>
                    <div>
            ...
            <div class="mt-6 lg:mt-0 flex-1 dark:text-gray-300 px-5 border-l border-r border-gray-200 dark:border-dark-5 border-t lg:border-t-0 pt-5 lg:pt-0">
                ...
                <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                    <div class="truncate sm:whitespace-normal flex items-center"> <i data-feather="user-check" class="w-4 h-4 mr-2"></i> {{ $stores->user->name }} </div>
                    <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i data-feather="mail" class="w-4 h-4 mr-2"></i> {{ $stores->user->email }} </div>
                    <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i data-feather="phone" class="w-4 h-4 mr-2"></i> {{ $stores->user->phone }} </div>
                </div>
            </div>
                        ...
                        @foreach ($products as $product)
                            <div class="flex flex-col sm:flex-row py-2">
                                <div class="mr-auto">
                                    ...
                                    <div class="text-gray-600 mt-1">{{ $product->subcategory->name }}</div>
                                </div>
                            </div>
                        @endforeach
