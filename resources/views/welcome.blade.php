...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <script>
            var firebaseConfig = {
            apiKey: "AIzaSyBfNZ1tj1aIwUGRIiBv3ZKg2Iz_t8Mwwvo",
            authDomain: "otp-autentication-f72d5.firebaseapp.com",
            projectId: "otp-autentication-f72d5",
            storageBucket: "otp-autentication-f72d5.appspot.com",
            messagingSenderId: "853595296649",
            appId: "1:853595296649:web:82d054ca5a3929aeb74758"
            };
